...
/// @return A bignum array which represents the encrypted blocks with a zero block at the end to calculate the number of blocks.
...
/// @return A string as unsigned char which represents the decrypted blocks.
